...
class Config implements ConfigInterface
{
    ...
    {
        $this->public_key = config('payment.gateways.mpesa.public_key');
        $this->api_host = config('payment.gateways.mpesa.endpoint');
        $this->api_key = config('payment.gateways.mpesa.api_key');
        $this->origin = '*';
        $this->service_provider_code = config('payment.gateways.mpesa.service_provider_code');
        $this->initiator_identifier = config('payment.gateways.mpesa.initiator_identifier');
        $this->security_credential = config('payment.gateways.mpesa.security_credential');
    }
