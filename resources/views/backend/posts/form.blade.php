...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ isset($post) ? $post->title : trans('admin.add_article') }}</li>
    </ol>
            ...
            <div class="col-sm-8 col-12">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link active" href="#news" data-toggle="pill"><i class="fas fa-fw fa-newspaper"></i> {{ __('admin.news') }}</a></li>
                            <li class="nav-item"><a href="#advanced" class="nav-link" data-toggle="pill"><i class="fas fa-fw fa-cog"></i> {{ __('admin.advanced') }}</a></li>
                            <li class="nav-item"><a href="#access" class="nav-link" data-toggle="pill"><i class="fas fa-fw fa-lock"></i> {{ __('admin.access') }}</a></li>
                        </ul>
