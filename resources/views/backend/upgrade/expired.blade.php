        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    <h6 class="m-0 font-weight-bold text-primary">AI Engine Update Support Expired</h6>
                </div>
                <div class="card-body">
                   <!--
                    <div class="alert alert-danger">Your maintenance and support has expired. The system still going to update, but Auto-Update will soon being disabled. Please renew your support term at <a href="https://codecanyon.net/item/aiengine-music-social-networking/28641149" class="text-danger">codecanyon.net</a>.</div>
                   -->
                    <div>
