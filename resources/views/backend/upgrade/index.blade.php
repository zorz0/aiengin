        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    <h6 class="m-0 font-weight-bold text-primary">AI Engine Update Wizard</h6>
                </div>
                <div class="card-body">
                    <p>Welcome to the AI Engine automatic update system. Before continuing with the update, be sure to <a href="{{ route('backend.backup-list') }}" class="text-warning" target="_blank">backup</a> your files on the server, otherwise in case of problems your data will not be restored.</p>
