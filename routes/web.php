...
Route::group([], function() {
    ...
    Route::group(['prefix' => env('APP_ADMIN_PATH', 'admin'), 'namespace' => 'App\Http\Controllers\Backend', 'as' => 'backend.'], function() {
    ...
    Route::group(['middleware' => 'admin', 'prefix' => env('APP_ADMIN_PATH', 'admin'), 'namespace' => 'App\Http\Controllers\Backend', 'as' => 'backend.'], function() {
